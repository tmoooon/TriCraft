package org.tmon.tricraft.item.custom.shovel;
...
public class customShovelItem extends MiningToolItem {
    ...
    public customShovelItem(GigeriumToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
