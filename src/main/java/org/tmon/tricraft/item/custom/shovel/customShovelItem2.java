...
public class customShovelItem2 extends MiningToolItem {
    ...
    public customShovelItem2(InesToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
