...
implements Vanishable{
    ...
    public customSwordItem(GigeriumToolMaterial gigeriumToolMaterial, int attackDamage, float attackSpeed, Settings settings) {
        super(gigeriumToolMaterial, settings);
        this.attackDamage = (float)attackDamage + gigeriumToolMaterial.getAttackDamage();
